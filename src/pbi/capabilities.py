...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        cli_support="The report command group now covers scalar settings, first-class report annotations, top-level object/array inspection and mutation, and dedicated resource package/item flows for `resourcePackages`, including file-backed item registration into RegisteredResources.",
        gap="There are still no higher-level helpers for organization custom visuals and some specialized report-level arrays.",
        next_step="Add organization custom visual editing and richer helpers around the remaining report-level arrays.",
        schema_refs=(REPORT_SCHEMA,),
    ),
)
