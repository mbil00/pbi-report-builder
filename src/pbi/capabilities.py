...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        cli_support="Full CRUD for model annotations, columns, measures, relationships, hierarchies, partitions, perspectives, and RLS roles/filters. Cascading DAX renames, dependency analysis, relationship path finding, model validation, cross-table search, and declarative YAML apply are implemented.",
