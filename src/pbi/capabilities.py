...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        commands=(
            ...
            "pbi catalog list", "pbi catalog get", "pbi catalog validate", "pbi catalog register",
            "pbi catalog create", "pbi catalog apply", "pbi catalog clone", "pbi catalog delete",
        ...
        cli_support="Declarative YAML apply with diff preview, post-apply invariants for missing visualType and malformed bookmark groups, page/visual export, group-preserving round-trip, unified catalog-managed page assets, visual style assets, reusable visual components with parameterized stamping including textbox content, layout position calculators, and semantic-model-driven visual builders on visual create are implemented.",
