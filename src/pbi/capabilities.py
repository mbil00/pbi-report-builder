...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        cli_support="Full CRUD for columns, measures, relationships, hierarchies, perspectives, and RLS roles/filters. Cascading DAX renames, dependency analysis, relationship path finding, model validation, cross-table search, and declarative YAML apply are implemented.",
        gap="Partitions and broader model-wide settings are not yet first-class.",
        next_step="Add partition management and broader model metadata editing.",
        schema_refs=(),
    ),
    Capability(
        domain="Filters",
