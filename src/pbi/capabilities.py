...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        status="supported",
        commands=("pbi filter list", "pbi filter add", "pbi filter delete"),
    ...
    Capability(
        ...
        status="partial",
        commands=("pbi apply", "pbi page export", "pbi page save-template", "pbi page apply-template", "pbi page templates", "pbi style create", "pbi style list", "pbi style get", "pbi style delete"),
