...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        cli_support="Full CRUD for columns, measures, relationships, hierarchies, and perspectives. Cascading DAX renames, dependency analysis, relationship path finding, model validation, cross-table search, and declarative YAML apply are implemented.",
        gap="Partitions, row-level security, and broader model-wide settings are not yet first-class.",
        next_step="Add RLS rules, partition management, and broader model metadata editing.",
        schema_refs=(),
    ),
    Capability(
        domain="Filters",
