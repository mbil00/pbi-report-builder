...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        cli_support="Full theme authoring from brand colors with auto-cascade, property inspection, editing with cascade control, reusable theme presets (project + global scope), and color migration across visual properties are implemented.",
        gap="Visual styles within themes (visualStyles section) are not yet authorable through the CLI.",
        next_step="Add visualStyles authoring for theme-level visual formatting overrides.",
