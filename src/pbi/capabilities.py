...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        status="supported",
        commands=("pbi page list", "pbi page get", "pbi page set", "pbi page create", "pbi page copy", "pbi page delete", "pbi page export"),
        pbi_support="Power BI supports page lifecycle, sizing, visibility, and ordering metadata.",
        cli_support="Page lifecycle, core page properties, and apply-compatible page export are implemented.",
        gap="Page authoring still lacks broader report-level page operations.",
    ...
    Capability(
        ...
        status="supported",
        commands=("pbi filter list", "pbi filter add", "pbi filter remove"),
    ...
    Capability(
        ...
        status="partial",
        commands=("pbi apply", "pbi page export", "pbi page save-template", "pbi page apply-template", "pbi page templates", "pbi style create", "pbi style list", "pbi style show", "pbi style delete"),
