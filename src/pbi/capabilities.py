...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        domain="Filters",
        feature="Categorical, include, exclude, tuple, range, and Top N filters",
        status="supported",
        ...
        cli_support="Schema-backed categorical, include, exclude, tuple, range, and Top N filter writes are implemented.",
    ...
    Capability(
        domain="Filters",
        feature="Relative date/time, passthrough, and visual top N",
        status="blocked",
        commands=("pbi filter add --relative",),
        ...
        next_step="Capture canonical PBIR samples for each filter mode and implement exact writers from those exported shapes.",
        schema_refs=(REPORT_SCHEMA, PAGE_SCHEMA, VISUAL_CONTAINER_SCHEMA),
    ),
    Capability(
        domain="Bookmarks",
