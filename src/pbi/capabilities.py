...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        commands=(
            ...
            "pbi nav page set", "pbi nav bookmark set", "pbi nav back set", "pbi nav url set",
        ...
        cli_support="Interaction edges plus noun-first navigation commands for page nav, bookmark toggle, back button, web URL, drillthrough actions, action inspection/cleanup, and report-page tooltip targeting are implemented.",
    ...
    Capability(
        ...
        cli_support="The report command group now covers scalar settings, first-class report annotations, and top-level object/array inspection and mutation for sections such as resourcePackages, filterConfig, objects, settings, and themeCollection.",
        gap="There is still no dedicated resource-package subgroup or higher-level helpers for organization custom visuals and other specialized report objects.",
        next_step="Add dedicated resource-package editing flows and richer helpers around the remaining report-level arrays.",
        schema_refs=(REPORT_SCHEMA,),
    ),
)
