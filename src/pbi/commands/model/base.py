...
model_annotation_app = typer.Typer(help="Semantic model annotation operations.", no_args_is_help=True)
...
model_partition_app = typer.Typer(help="Semantic model partition operations.", no_args_is_help=True)
...
model_app.add_typer(model_perspective_app, name="perspective", hidden=True)
model_app.add_typer(model_role_app, name="role", hidden=True)
